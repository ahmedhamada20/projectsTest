            ...
            <div class="col-md-8">
                <div id="page-main">
                    <section class="course-listing" id="courses">
                        <header><h1>الدورس</h1></header>
                        <div class="row">
                    
                            @forelse (getAlllessons() as $row)
                            <div class="col-md-4 col-sm-4">
                                <article class="course-thumbnail">
                                    <div class="description">
                                        ...
                                        <a href="{{ $row->url }}" target="_blank" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
