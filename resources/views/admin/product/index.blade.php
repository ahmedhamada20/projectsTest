            ...
            <div class="col-lg-12 posts-list">
                <div class="single-post">
                    <div class="feature-img">
                        <img class="img-fluid" src="{{asset('upload/product/'.$product->image)}}" alt="" style="width: 100%;height: 450px">
                    </div>
            ...
            <div class="col-lg-12 posts-list">
                <div class="single-post">
                    <div class="blog_details">
                        ...
                        @endif
                        <p>{{trans('app.category')}}:{{$product->category->name}}</p>
                        <a class="btn btn-success">{{$product->price}}{{trans('app.curnncy')}}</a>
